...
return null;
 ...
 console.log(teamColors("Charlotte Hornets"));
  ...
  function mostPointsScored() {
    ...
    for (const team of Object.values(nbaData)) {
        for (const [player, stats] of Object.entries(team.players)) {
            console.log(`Checking ${player}: ${stats.points} points`);
...
function winningTeam() {
    ...
    for (const team of Object.values(nbaData)) {
        teamPoints[team.teamName] = Object.values(team.players).reduce((sum, player) => sum + player.points, 0);
    }
    
    return teamPoints[nbaData.home.teamName] > teamPoints[nbaData.away.teamName] 
        ? nbaData.home.teamName 
        : nbaData.away.teamName;
}
